...
public class fragmentdonation extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragmentdonation, container, false);
        ImageView imageView = (ImageView) view.findViewById(R.id.web);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent=new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://pages.razorpay.com/amtm-donate"));
