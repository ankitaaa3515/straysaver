...
public class login2 extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        if(currentUser != null){
            ...
            Intent intent= new Intent(login2.this, MainActivitytoast.class);
        ...
        buttonlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(email)){
                    Toast.makeText(login2.this,"enter email",Toast.LENGTH_LONG).show();
                    return;
                }

                if(TextUtils.isEmpty(password)){
                    Toast.makeText(login2.this,"enter password",Toast.LENGTH_LONG).show();
                    return;
